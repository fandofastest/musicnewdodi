...
public class LocalFragment extends Fragment {
    ...
    OfflineMusic_RecycleView_Adapter topchart_adapter;
    ...
    final List<OfflineModalClass> tempAudioList = new ArrayList<>();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        context=getContext();
        topchart_adapter = new OfflineMusic_RecycleView_Adapter(context,listlocal);
