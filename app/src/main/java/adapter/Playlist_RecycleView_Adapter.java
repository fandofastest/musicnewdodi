...
public class Playlist_RecycleView_Adapter extends RecyclerView.Adapter<Playlist_RecycleView_Adapter.MyViewHolder> {
    ...
    Context context;
    private List<PlaylistModalClass> playlistModalClassList;




public Playlist_RecycleView_Adapter(Context mainActivityContacts, List<PlaylistModalClass> listModalClassList) {
...
public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        .inflate(R.layout.item_myplayalist, parent, false);
...
public void onBindViewHolder(final MyViewHolder holder, final int position){
        PlaylistModalClass modalClass = playlistModalClassList.get(position);
